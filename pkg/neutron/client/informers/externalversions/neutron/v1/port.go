	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.KubeovnV1().Ports(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubeovnV1().Ports(namespace).Watch(context.TODO(), options)
			},
		},
		&neutronv1.Port{},
		resyncPeriod,
...
func (f *portInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&neutronv1.Port{}, f.defaultInformer)
}

func (f *portInformer) Lister() v1.PortLister {
	return v1.NewPortLister(f.Informer().GetIndexer())
}
